...
$(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if(result && result.code === 200){
                            var url = $('#attach_url').val() + result.data[0].fkey;
                            console.log('url =>' + url);
    ...
    if($('#thumb-toggle').attr('thumb_url') != null){
    ...
    $("#dropzone").dropzone({
        ...
        init: function() {
            this.on('success', function (files, result) {
                ...
                if(result && result.code === 200){
                    var url = attach_url + result.data[0].fkey;
                    console.log('url => ' + url);
...
function  autoSave() {
    ...
    if (title != '' && content != '') {
        ...
        tale.post({
            ...
            success: function (result) {
                if (result && result.code === 200) {
                    $('#articleForm #cid').val(result.data);
                } else {
